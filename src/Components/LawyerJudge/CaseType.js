...
const CaseType = () => {
  ...
  return (
    ...
    <h2 className="text-3xl font-bold text-center text-indigo-600 mb-8">Search By Case Type</h2>
    <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            <label className="font-medium text-gray-700">Case Type:</label>
            <input
                type="text"
                value={caseType}
