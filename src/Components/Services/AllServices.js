...
import { FaUserPlus, FaGavel, FaFolderOpen, FaCheckCircle, FaCalendarAlt, FaPlusSquare, FaRegEdit, FaHistory,  FaSearch, FaIdBadge, FaBuilding, FaCalendarDay, FaBalanceScale, FaUserShield, FaUserTie, FaUniversity, FaUser } from "react-icons/fa";
...
export const registrarMenuItems = [
  ...
  { to: "update-case", icon: <FaRegEdit />, label: "Update Case" },
